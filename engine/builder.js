...
Game.Builder.prototype._generateLevel = function() {
    ...
    generator.create(function(x,y,v) {
        if (v === 1) {
            ...
            map[x][y] = Game.Tile.undergroundWallTile;
        }
    });
    return map;
};
    ...
    for (var x = 0; x < this._width; x++) {
        for (var y = 0; y < this._height; y++) {
            if (this._regions[z][x][y] == region) {
                ...
                this._regions[z][x][y] = 0;
                this._tiles[z][x][y] = Game.Tile.undergroundWallTile;
            }
        }
    }
};
...
Game.Builder.prototype._findRegionOverlaps = function(z, r1, r2) {
    ...
    for (var x = 0; x < this._width; x++) {
        for (var y = 0; y < this._height; y++) {
            if (this._tiles[z][x][y]  == Game.Tile.undergroundFloorTile &&
                this._tiles[z+1][x][y] == Game.Tile.undergroundFloorTile &&
...
Game.Builder.prototype._connectRegions = function(z, r1, r2) {
    ...
    var point = overlap[0];
    this._tiles[z][point.x][point.y] = Game.Tile.undergroundStairsDownTile;
    this._tiles[z+1][point.x][point.y] = Game.Tile.undergroundStairsUpTile;
    return true;
};
